...
1. **Сбор данных** (каждые 5 минут):
   - Исторические 5-минутные графики BTC/USDT за последние 3 месяца
   - Исторические данные по золоту (XAUT/USDT)
   - Исторические данные по серебру (XAGUSD)
...
| `TRADING_PAIR` | Криптовалютная пара для торговли | BTCUSDT |
| `MAX_TRADE_AMOUNT` | Максимальная сумма одной сделки (USDT) | 10 |
| `INTERVAL_MINUTES` | Интервал запуска агента (минуты) | 5 |
| `HISTORICAL_MONTHS` | Количество месяцев исторических данных | 3 |
